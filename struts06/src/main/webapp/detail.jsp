...
<form action="update.bit">
  ...
  <div class="form-group">
    ...
    <input type="text" value="${bean.sub }" class="form-control" name="sub" id="sub" placeholder="제목을 입력하세요" />
  </div>
  <div class="form-group">
    <label for="name">글쓴이</label>
    <input type="text" value="${bean.name }" class="form-control" name="name" id="name" placeholder="이름을 입력하세요" />
  </div>
  <div class="form-group">
